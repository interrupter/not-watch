// Copyright 2023 Aleksandr Repin
// Original code accomplied with minor patches to support watching of files.
...
function createMonitor(root, options, cb) {
    if (!cb) {
        cb = options;
        options = {};
    }
    let monitor = new events.EventEmitter();
...
export { watchTree, unwatchTree, createMonitor, walk };
